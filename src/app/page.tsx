...
import { RefreshCw, BookOpen, Undo2, View, Bot, Globe, Link2Off, Flag, Trophy, Settings, Volume2, BrainCircuit, Swords, Package, Copy, RotateCcw, Landmark } from 'lucide-react';
    ...
    <div className="relative z-20 flex flex-col flex-grow w-full p-0.5 lg:hidden overflow-y-auto scrollbar-hide">
      <div className="flex flex-col items-center justify-between gap-0.5 pb-1">
        ...
        <div className="flex flex-wrap justify-center items-center gap-0.5 mt-0.5">
          ...
          <Button variant="outline" size="sm" onClick={() => setIsRoyalStoreOpen(true)} className="h-6 px-1.5 text-[0.65rem]"><Landmark className="mr-1 h-3 w-3" /> Store</Button>
      ...
      <AlertDialog open={abilityChoiceDialog?.isOpen} onOpenChange={(open) => !open && setAbilityChoiceDialog(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>This piece has multiple special actions available. Choose one to perform.</AlertDialogDescription>
          </AlertDialogHeader>
