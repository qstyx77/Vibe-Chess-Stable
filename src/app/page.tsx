  ...
  const handleSquareClick = useCallback((algebraic: AlgebraicSquare) => {
    ...
    if (isAwaitingRayTarget) {
        if (selectedSquare) {
            ...
            if ((dr === 0 || dc === 0) && fromSquare !== algebraic) {
