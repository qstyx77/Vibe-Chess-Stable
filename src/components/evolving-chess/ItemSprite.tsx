  ...
  const renderIcon = () => {
    switch (type) {
      case 'chameleon_cloak':
        return (
          <svg viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full drop-shadow-md">
            <rect x="3" y="1" width="4" height="4" fill="#22C55E" />
            <rect x="2" y="2" width="6" height="3" fill="#22C55E" />
            <rect x="1" y="5" width="8" height="6" fill="#10B981" />
            <rect x="0" y="6" width="10" height="5" fill="#059669" />
            <rect x="4" y="5" width="2" height="1" fill="#FFF" opacity="0.4" />
            <rect x="3" y="8" width="4" height="1" fill="#FFF" opacity="0.2" />
          </svg>
        );
      case 'oil_slick':
        return (
      ...
      case 'gamblers_coin':
        return (
          <svg viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full drop-shadow-md">
            ...
            <rect x="3" y="1" width="4" height="10" fill="#EAB308" />
            <rect x="4" y="4" width="2" height="4" fill="#B45309" />
            <rect x="3" y="2" width="1" height="1" fill="#FEF08A" />
      ...
      case 'sweet_revenge':
        return (
          <svg viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full drop-shadow-md">
            <rect x="4" y="0" width="2" height="7" fill="#94A3B8" />
            <rect x="3" y="2" width="4" height="4" fill="#CBD5E1" />
            <rect x="2" y="7" width="6" height="1" fill="#475569" />
            <rect x="4" y="8" width="2" height="4" fill="#78350F" />
            <rect x="3" y="9" width="4" height="1" fill="#B45309" />
            <rect x="4" y="2" width="1" height="3" fill="#FFF" opacity="0.5" />
          </svg>
        );
      case 'power_glove':
        return (
      ...
      case 'portal_scroll_50':
        ...
        let portalColor = '#3B82F6';
        if (floorNum === 10) portalColor = '#22D3EE';
        else if (floorNum === 30) portalColor = '#8B5CF6';
        else if (floorNum === 40) portalColor = '#EAB308';
        else if (floorNum === 50) portalColor = '#F43F5E';
        return (
          <svg viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full drop-shadow-md">
      ...
      case 'heavy_rain':
        ...
        return (
          <svg viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full drop-shadow-md">
            ...
            <rect x="3" y="4" width="4" height="4" fill={iconColors[type] || '#000'} opacity={type === 'demonic_possession' ? 1 : 0.6} />
      ...
      case 'war_drum':
        return (
          <svg viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full drop-shadow-md">
            <rect x="1" y="3" width="8" height="6" fill="#78350F" />
            <rect x="2" y="2" width="6" height="1" fill="#92400E" />
            <rect x="2" y="9" width="6" height="1" fill="#92400E" />
            <rect x="2" y="3" width="6" height="6" fill="#FDE68A" opacity="0.5" />
          </svg>
        );
      case 'cyanide_pill':
        return (
