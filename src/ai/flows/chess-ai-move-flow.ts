...
1.  **AGGRESSIVE CAPTURES & MATERIAL ADVANTAGE (CRUCIAL PRIORITY):** Your primary offensive goal is to gain a material advantage by capturing enemy pieces.
    *   **Prioritize Legal Captures:** If a legal capture is available that does not result in an immediate checkmate against you or a catastrophic loss of material for no gain, **THIS SHOULD BE YOUR PREFERRED TYPE OF MOVE over a simple pawn move or minor piece repositioning, ESPECIALLY if it involves a higher-value piece (Queen > Rook > Bishop/Knight > Pawn) or a piece posing an immediate threat.**
    *   **Avoid Overly Passive Play:** Do not opt for a simple pawn move if a reasonable and legal capture opportunity exists that improves your material standing or tactical position without undue risk.
