...
5.  **Piece Development:** Especially in the early game, move your Knights and Bishops off their starting squares towards the center or influential positions. Do not just move pawns if better capturing, checkmating, or developing moves are available.
...
9.  **Pawn Structure:** While pawn moves are common, ensure they support your overall strategy and don't create weaknesses. Pawn moves should generally be made if no better capturing, checkmating, threatening, or developing moves are available.
