 ...
 * Row Height: 12px
 * Y-Nudge: +1px to avoid bleeding from row above
 */
export const ITEM_METADATA: Record<InventoryItemType, ItemMetadata> = {
  // Potions (Row 15 - Y:180)
  'health_potion': { name: 'Health Potion', description: 'Restores vitality.', x: 750, y: 181, isConsumable: true },
  'mana_potion': { name: 'Mana Potion', description: 'Restores energy.', x: 740, y: 181, isConsumable: true },
  'speed_potion': { name: 'Haste Potion', description: 'Move twice.', x: 770, y: 181, isConsumable: true },
  
  // Food (Row 11 - Y:132)
  'apple': { name: 'Crisp Apple', description: 'Quick snack.', x: 680, y: 133, isConsumable: true },
  'ham': { name: 'Roasted Ham', description: 'Hearty meal.', x: 690, y: 133, isConsumable: true },
  'cheese': { name: 'Cave Cheese', description: 'Aged well.', x: 700, y: 133, isConsumable: true },
  'steak': { name: 'Grizzly Steak', description: 'Power food.', x: 710, y: 133, isConsumable: true },
  'bread': { name: 'Elven Bread', description: 'Sustenance.', x: 720, y: 133, isConsumable: true },

  // Scrolls (Row 25 - Y:300)
  'fireball_scroll': { name: 'Fireball Scroll', description: 'Explosive magic.', x: 720, y: 301, isConsumable: true },
  'phoenix_down': { name: 'Phoenix Down', description: 'Resurrects unit.', x: 750, y: 301, isConsumable: true }, 
  
  // Tools (Row 10 - Y:120)
  'pickaxe': { name: 'Iron Pickaxe', description: 'Breaks blocks.', x: 680, y: 121, isConsumable: false },
  'shovel': { name: 'Sturdy Shovel', description: 'For digging.', x: 690, y: 121, isConsumable: false },
  'torch': { name: 'Everlasting Torch', description: 'Lights the way.', x: 710, y: 121, isConsumable: false },

  // Bombs (Row 9 - Y:108)
  'grenade': { name: 'Grenade', description: 'Explosive.', x: 680, y: 109, isConsumable: true },
  'bomb': { name: 'Mega Bomb', description: 'Large blast.', x: 690, y: 109, isConsumable: true },

  // Portal Scrolls (Row 25)
  'portal_scroll_10': { name: 'F10 Portal', description: 'Warp to Floor 10.', x: 820, y: 301, isConsumable: true },
  'portal_scroll_20': { name: 'F20 Portal', description: 'Warp to Floor 20.', x: 830, y: 301, isConsumable: true },
  'portal_scroll_30': { name: 'F30 Portal', description: 'Warp to Floor 30.', x: 840, y: 301, isConsumable: true },
  'portal_scroll_40': { name: 'F40 Portal', description: 'Warp to Floor 40.', x: 850, y: 301, isConsumable: true },

  // Weapons (Row 17-21)
  'iron_sword': { name: 'Iron Sword', description: 'Standard blade.', x: 680, y: 205, isConsumable: false },
  'claymore': { name: 'Claymore', description: 'Heavy blade.', x: 690, y: 205, isConsumable: false },
  'battle_axe': { name: 'Battle Axe', description: 'Cleaving edge.', x: 680, y: 217, isConsumable: false },
  'mace': { name: 'Iron Mace', description: 'Blunt force.', x: 680, y: 229, isConsumable: false },
  'morning_star': { name: 'Morning Star', description: 'Spiked crush.', x: 690, y: 229, isConsumable: false },
  'magic_staff': { name: 'Crystal Staff', description: 'Mana focus.', x: 680, y: 253, isConsumable: false },
  'wand': { name: 'Elder Wand', description: 'Quick cast.', x: 700, y: 253, isConsumable: false },
  'long_bow': { name: 'Long Bow', description: 'Ranged attack.', x: 680, y: 241, isConsumable: false },
  'crossbow': { name: 'Heavy Crossbow', description: 'Piercing bolts.', x: 700, y: 241, isConsumable: false },

  // Shields (Row 30 - Y:360)
  'wooden_shield': { name: 'Buckler', description: 'Light defense.', x: 680, y: 361, isConsumable: false },
  'iron_shield': { name: 'Kite Shield', description: 'Solid defense.', x: 690, y: 361, isConsumable: false },
  'spiked_shield': { name: 'Spiked Shield', description: 'Thorny defense.', x: 700, y: 361, isConsumable: false },
  'mirror_shield': { name: 'Mirror Shield', description: 'Reflects captures.', x: 770, y: 361, isConsumable: true },

  // Armor (Row 23 - Y:276)
  'plate_armor': { name: 'Full Plate', description: 'Solid protection.', x: 680, y: 277, isConsumable: false },
  'passive_armor': { name: 'Heavy Armor', description: 'Push-Back immunity.', x: 690, y: 277, isConsumable: false },
  
  // Helmets (Row 22 - Y:264)
  'iron_helmet': { name: 'Iron Helmet', description: 'Head guard.', x: 680, y: 265, isConsumable: false },
  'knight_helmet': { name: 'Greathelm', description: 'Heavy guard.', x: 690, y: 265, isConsumable: false },
  'wizard_robe': { name: 'Arcane Robe', description: 'Magic boost.', x: 730, y: 277, isConsumable: false },
  
  // Cloaks (Row 23)
  'swift_cloak': { name: 'Swift Cloak', description: 'Move 2 spaces.', x: 720, y: 277, isConsumable: false },
  
  // Jewelry (Row 28 - Y:336)
  'gold_ring': { name: 'Gold Ring', description: 'Valuable.', x: 750, y: 337, isConsumable: false },
  'ruby_ring': { name: 'Ruby Ring', description: 'Fire resist.', x: 760, y: 337, isConsumable: false },
  'emerald_pendant': { name: 'Emerald Pendant', description: 'Nature blessing.', x: 790, y: 337, isConsumable: false },
};
