...
export const ITEM_METADATA: Record<InventoryItemType, ItemMetadata> = {
  ...
  'training_weights': { name: 'Training Weights', description: 'Conditioning: +1 level every 5 turns. Any action causes immediate exhaustion.', isConsumable: false, rarity: 'common' },
