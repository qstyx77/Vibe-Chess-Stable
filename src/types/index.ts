...
export const ITEM_METADATA: Record<InventoryItemType, ItemMetadata> = {
  ...
  'sclerotia': { name: 'Sclerotia', description: 'Mushroom amulet. Myco Mage only. Adds 1 Shroom Mana every 4 turns. [ALCHEMIST SET: w/ Antidote, Spore Pouch. Bonus: Double Shrooms.]', isConsumable: false, rarity: 'rare' },
