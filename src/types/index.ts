...
export const ITEM_METADATA: Record<InventoryItemType, ItemMetadata> = {
  'passive_armor': { name: 'Blue Plate', description: 'Heavy chestplate. Push-Back immunity. [HEAVY GUARD SET: w/ Lead Boots, Weighted Helm. Bonus: Frontline Push/Pull immune.]', isConsumable: false, rarity: 'common' },
  ...
  'poison_sword': { name: 'Poison Dagger', description: 'Toxic blade. Splashes poison on capture. [TOXIC CLOUD SET: w/ Poison Tunic, Spiked Plate. Bonus: Adjacency poisons enemies.]', isConsumable: false, rarity: 'rare' },
  ...
  'grimoir': { name: 'Grimoir', description: 'Dark book. Boosts adjacent allies by +2 levels. [REAPER\'S TITHE SET: w/ Leach Blade, Soul Harvest. Bonus: Stolen levels distributed randomly.]', isConsumable: false, rarity: 'rare' },
  ...
  'logas': { name: 'Logas', description: 'Holy book. Grants adjacent allies +1 level on their captures. [LUMINOUS SET: w/ Gnosis, Golden Chalice. Bonus: Shared Divinity.]', isConsumable: false, rarity: 'uncommon' },
  ...
  'leach_blade': { name: 'Leach Blade', description: 'Dark blade. Capturing reduces adjacent enemies level. [REAPER\'S TITHE SET: w/ Grimoir, Soul Harvest. Bonus: Stolen levels distributed randomly.]', isConsumable: false, rarity: 'rare' },
  ...
  'lead_boots': { name: 'Lead Boots', description: 'Passive. Equipped unit cannot be moved by Push-Back or Gravity effects. [HEAVY GUARD SET: w/ Blue Plate, Weighted Helm. Bonus: Frontline Push/Pull immune.]', isConsumable: false, rarity: 'common' },
  ...
  'training_weights': { name: 'Training Weights', description: 'Conditioning: +1 level every 5 turns. Actions cause immediate exhaustion.', isConsumable: false, rarity: 'common' },
  ...
  'soul_harvest': { name: 'Soul Harvest Scroll', description: 'Consumable. Non-Royal. Reduces adjacent levels to 1; user gains power. [REAPER\'S TITHE SET: w/ Grimoir, Leach Blade. Bonus: Stolen levels distributed randomly.]', isConsumable: true, rarity: 'rare' },
  ...
  'golden_chalice': { name: 'Golden Chalice', description: 'Passive. Increases the Experience Value of all captures by this unit by +1 Level. [LUMINOUS SET: w/ Logas, Gnosis. Bonus: Shared Divinity.]', isConsumable: false, rarity: 'rare' },
  ...
  'sclerotia': { name: 'Sclerotia', description: 'Mushroom amulet. Myco Mage only. Adds 1 Shroom Mana every 5 turns. [ALCHEMIST SET: w/ Antidote, Spore Pouch. Bonus: Double Shrooms.]', isConsumable: false, rarity: 'rare' },
  ...
  'smoke_bomb': { name: 'Smoke Bomb', description: 'Escape tool. On capture, wearer escapes to back rank. Consumable. [ASSASSIN SET: w/ Obsidian Blade, Chameleon Cloak. Bonus: L5+ Frontline become Infiltrators.]', isConsumable: true, rarity: 'uncommon' },
  ...
  'spore_pouch': { name: 'Spore Pouch', description: 'Common bag. Frontline only. 25% chance to spawn a Shroom on vacated square. [ALCHEMIST SET: w/ Antidote, Sclerotia. Bonus: Double Shrooms.]', isConsumable: false, rarity: 'common' },
  ...
  'weighted_helm': { name: 'Weighted Helm', description: 'Common Passive. Piece is completely immune to Archer Snipes. [HEAVY GUARD SET: w/ Blue Plate, Lead Boots. Bonus: Frontline Push/Pull immune.]', isConsumable: false, rarity: 'common' },
  ...
  'obsidian_blade': { name: 'Obsidian Blade', description: 'Common Passive. Equipped unit can capture pieces that have a Holy Shield. [ASSASSIN SET: w/ Smoke Bomb, Chameleon Cloak. Bonus: L5+ Frontline become Infiltrators.]', isConsumable: false, rarity: 'common' },
...
export const ITEM_SETS: Record<string, ItemSet> = {
  ...
  reapers_tithe: {
    name: "Reaper's Tithe Set",
    items: ['soul_harvest', 'leach_blade', 'grimoir'],
    bonus: "Reaper's Tithe: Captured enemy units return to the graveyard at Level 1. Their extra levels are distributed randomly among units wearing items of this set."
  }
};
